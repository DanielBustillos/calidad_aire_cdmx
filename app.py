...
app.layout= html.Div([html.Header([html.Div([html.Button([html.Div(className='bar1'),
                                                ...
                                                html.Div(className='bar3')], id='myBtn', className='dropbtn'),
                                   html.Div([html.Button(html.Span('Pronóstico'), id='pronostico_button', n_clicks_timestamp=0, className='button'),
                                             html.Button(html.Span('Concentraciones'), id='concentracion_button', n_clicks_timestamp=0, className='button'),
                                             html.Button(html.Span('Documentación'), id='documentacion_button', n_clicks_timestamp=0, className='button')],
                                            id='myDropdown', className='dropdown-content')], className='dropdown'),
                                   html.Div([html.H2('Calidad del aire CDMX')], id='titulo-app', className='titulo-app'),
                                   html.A([html.Img(src=app.get_asset_url('conacyt.png'), alt="logo de conacyt", className='logo')], href='https://conacyt.gob.mx')]),
                      html.Div(id='contenido', className='contenedor-global')
                      # html.Div("Coordinación de Ciencias de Datos - 2019", className='pie-app')
                      ])
